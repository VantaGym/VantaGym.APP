...
import style from "./NovoExercicio.module.css"
...
export function NovoExercicio() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await ExercicioAPI.criarAsync(nome, series, repeticoes, grupoMuscular, id);
                ...
                <Topbar>
                    <main className={style.conteudo}>
                        <div className={style.cabecalho}>
                            ...
                            <p>Adicione um novo exercício à sua ficha de treino.</p>
                        </div>
                        ...
                        <Form onSubmit={handleSubmit} className={style.formulario}>
                            ...
                            <div className={style.botoes}>
                                <Button className={style.botaoCancelar} onClick={() => navigate(`/fichasTreino/${id}`)}>
                                    Cancelar
                                </Button>
